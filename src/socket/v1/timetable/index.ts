        ...
        this.models = [
            {
                ...
                path: "/:when",
                // authType: "access",
                controller: Timetable.onGetTimetable,
            },
            {
                method: "put",
                path: "/:when",
                // authType: "access",
                controller: Timetable.onPutTimetable,
            },
        ];
    }

    static async onGetTimetable(req: Request, res: Response) {
        try {
            const getTimetableRequest: v1.GetTimetableRequest =
                req.params as any;
